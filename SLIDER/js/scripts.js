...
---------------------------------------------------*/	
	...
	function FirstLoad() {	
		...
		$('.split-slider a.ajax-link-project').on('click', function(event) {
			event.preventDefault(); // Verhindert das Standardverhalten des Links (Seitenneuladen)
		
			var projectUrl = $(this).attr('href'); // Die URL des verlinkten Projekts
...
/*--------------------------------------------------
Function Sliders ajax-link-project
---------------------------------------------------*/
